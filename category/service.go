...
type Service interface {
	...
	create(ctx context.Context, req category) (err error)
	findByID(ctx context.Context, id string) (response findByIDResponse, err error)
	deleteByID(ctx context.Context, id string) (err error)
	update(ctx context.Context, req category) (err error)
}
...
func (cs *categoryService) create(ctx context.Context, c category) (err error) {
	err = c.Validate()
	if err != nil {
...
func (cs *categoryService) update(ctx context.Context, c category) (err error) {
	err = c.Validate()
	if err != nil {
